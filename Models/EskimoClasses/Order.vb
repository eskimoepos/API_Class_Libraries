...
''' </summary>
Public MustInherit Class clsOrderBase(Of T As iOrderItem)
    ...
    ''' <returns></returns>
    <Required>
    Property OrderType As Integer = clsOrder.OrderTypeEnum.WebOrder
    ...
    ''' <remarks></remarks>
    <Required>
    Property OrderedItems As New List(Of T)
