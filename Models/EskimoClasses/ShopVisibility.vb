...
Public Class clsShopVisibility
    ...
    Public VisibileEverywhere As Boolean
    ...
    Sub New(strInput As String)
        If Not String.IsNullOrEmpty(strInput) Then
            If strInput.ToUpper.Equals("ALL") Then
                VisibileEverywhere = True
            Else
                Dim IDs As List(Of String)

                IDs = Strings.Split(strInput, "|").ToList
                ShopIDs = IDs.OrderBy(Function(x) Convert.ToInt32(x))
            End If
        End If
    End Sub
    ...
    Public Function Validate(validationContext As ValidationContext) As IEnumerable(Of ValidationResult) Implements IValidatableObject.Validate
        ...
        If ShopIDs IsNot Nothing AndAlso ShopIDs.Any And VisibileEverywhere Then
            lst.Add(New ValidationResult("If VisibileEverywhere is true, there is no need to pass any Shop IDs"))
        End If

        If Not VisibileEverywhere AndAlso ShopIDs IsNot Nothing AndAlso ShopIDs.Any Then
